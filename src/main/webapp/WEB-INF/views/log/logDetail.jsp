    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form method="post">
            <table class="grid">
                ...
                <tr>
                    <td>请求参数</td>
                    <td colspan="3"><input style="width: 394px; height: 29px;padding-left: 4px" required="required" data-options="editable:false" value="${log.operationParams}"></td>
                </tr>
                <tr>
                    <td>IP地址</td>
                    <td><input autocomplete="off" type="text" placeholder="请输入角色名称" class="easyui-validatebox span2" data-options="required:true" value="${log.operationIp}"></td>
                    <td>操作人</td>
